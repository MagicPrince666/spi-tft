...
//gui时间计数器,需要在外部实现
//gui定时器,每10ms增加1次
#define GUI_TIMER_10MS	10 * 1000 	//ucos的调度时间设置为5ms 
...
extern const char* GUI_OK_CAPTION_TBL[GUI_LANGUAGE_NUM]; 			//确认按钮
extern const char* GUI_OPTION_CAPTION_TBL[GUI_LANGUAGE_NUM];		//选项按钮
extern const char* GUI_BACK_CAPTION_TBL[GUI_LANGUAGE_NUM];		//取消按钮
extern const char* GUI_CANCEL_CAPTION_TBL[GUI_LANGUAGE_NUM];		//取消按钮
extern const char* GUI_QUIT_CAPTION_TBL[GUI_LANGUAGE_NUM];		//退出按钮	 
////////////////////////////////////////////////////////////////////////////////////////////////////////
//gui颜色定义
