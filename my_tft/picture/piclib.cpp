...
//图片在开始和结束的坐标点范围内显示
uint8_t ai_load_picfile(const uint8_t *filename,uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t fast,uint8_t temp)
{	
	uint8_t	res;//返回值
//	uint8_t temp;	
//	struct stat STFile;
